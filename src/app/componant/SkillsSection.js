      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
            <h3 className="text-3xl font-semibold text-center text-blue-400 mb-6">{translations?.SkillsSection?.Frontend}</h3>
          ...
          {/* Backend Skills */}
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
            <h3 className="text-3xl font-semibold text-center text-blue-400 mb-6">{translations?.SkillsSection?.Backend}</h3>
            <div className="flex flex-wrap justify-center items-center gap-6">
              <div className=" text-center">
          ...
          {/* Other Skills */}
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
            <h3 className="text-3xl font-semibold text-center text-blue-400 mb-6">{translations?.SkillsSection?.Other}</h3>
            <div className="flex flex-wrap justify-center items-center gap-6">
              <div className=" text-center">
