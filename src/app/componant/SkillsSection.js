    ...
    return (
        <section className="py-10 bg-gradient-to-r from-[#0c3541] to-[#0e40e6] text-white">
            <div className="container mx-auto px-4">
                <h2 className="text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 mb-10"> {translations?.SkillsSection?.Skills} </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 ">
                    {/* Frontend Skills */}
                    <div className="relative bg-[0x87CEEB] p-6 rounded-xl shadow-[-10px_20px_30px_0px_rgba(23,23,23,1)] hover:shadow-[-20px_20px_30px_0px_rgba(23,23,23,1)] hover:scale-105 transition-transform duration-300">
                        <h3 className="relative text-3xl z-20 font-semibold text-center text-blue-900 mb-6">{translations?.SkillsSection?.Frontend}</h3>
                        <SpiderWeb />
                        <div className="flex flex-wrap justify-center  z-20 relative items-center gap-6">
                            ...
                            <div className=" text-center">
                                <div className="skill-icon text-black hover:text-[#fff] text-5xl mb-4">
                                    <svg className="w-16 h-16 mx-auto" viewBox="0 0 128 128">
                    ...
                    {/* Backend Skills */}
                    <div className="relative shadow-[-10px_20px_30px_0px_rgba(23,23,23,1)] hover:shadow-[-20px_20px_30px_0px_rgba(23,23,23,1)] bg-gray-800 p-6 rounded-xl hover:scale-105 transition-transform duration-300">
                        <h3 className="relative z-20 text-3xl font-semibold text-center text-blue-900 mb-6">{translations?.SkillsSection?.Backend}</h3>
                        <SpiderWeb />
                        <div className="flex flex-wrap justify-center z-20 relative items-center gap-6">
                            <div className=" text-center">
                            ...
                            <div className=" text-center">
                                <p className="text-lg text-[#359135] font-bold hover:text-[#55f855]">Express.js</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative shadow-[-10px_20px_30px_0px_rgba(23,23,23,1)] hover:shadow-[-20px_20px_30px_0px_rgba(23,23,23,1)] bg-gray-800 p-6 rounded-xl hover:scale-105 transition-transform duration-300">
                        ...
                        <h3 className="text-3xl relative font-semibold text-center text-blue-900 mb-6">{translations?.SkillsSection?.Other}</h3>
                        <div className="flex flex-wrap justify-center relative z-20 items-center gap-6">
                            <div className=" text-center">
